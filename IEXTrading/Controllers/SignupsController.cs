...
namespace IEXTrading.Controllers
{
    public class SignupsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,age,first_name,last_name,age,Email,activity,recreation_center,days_of_week,times")] Signup signup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,age,first_name,last_name,age,Email,activity,recreation_center,days_of_week,times")] Signup signup)
        {
            if (id != signup.Id)
            {
                return NotFound();
